...
public class productController {
    ...
    static {
        products.add(new product(idCount++, "ss9", "Canon", 870, "Canon.jpg"));
        products.add(new product(idCount++, "lt75", "Iphone", 1120, "iphone.jpg"));
        products.add(new product(idCount++, "ko9", "Huawei", 1200, "huawei.jpg"));
